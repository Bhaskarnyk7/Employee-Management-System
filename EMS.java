...
class Employee_Add
{
    public void createFile()
    {
        ...
        emp.getInfo();
        try{
            File f1=new File("file"+emp.employ_id+".txt");   //(Creates only file object)  // probably creating a text file for each employee, with the filename indicating the employee's ID.
            if(f1.createNewFile()){
